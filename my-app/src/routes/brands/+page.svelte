...
<script lang="ts">
	...
	import Alphabet from "~icons/bi/alphabet";
	import SortAlphabetical from "~icons/lineicons/sort-alphabetical";
    import BrandCarousel from '$lib/components/brand-carousel.svelte';
